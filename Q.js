...
{return numSi(countStr(String(numSi(num0,s0,10))+sign+String(numSi(num1,s1,10))),10,s2);}function map(num,num_min,num_max,new_min,new_max){var num_range=num_max-num_min;
var new_range=new_max-new_min;var converted=((num-num_min)*new_range/num_range)+new_min;return converted;}